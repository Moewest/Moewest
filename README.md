...
- I use prepared statements, CSRF/CSP controls, MFA, rate limiting, audit logging, session and upload controls, Playwright regression tests, and Lighthouse audits. Additional languages include Python and Bash; I use Git/GitHub for version control.
...
- Technical coordination: CAD drawing, technical documentation, database and records management, survey-information verification, leading meetings, and presenting updates.
- Academic foundations: software engineering, algorithms and data structures, object-oriented Java programming, and machine learning and AI coursework. Technical training also includes networking and network security.
- Community technical work: PC assembly, troubleshooting and technical support, plus computer science tutoring focused on debugging and problem solving.
- AV and live production: camera operation, live video switching, presentation graphics, audio, and livestream production. Community volunteering also includes public speaking.
